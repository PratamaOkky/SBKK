    ...
    <div class="container-wrapper">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($results as $item): ?>
                            <tr style="transition: background-color 0.3s;">
                                ...
                                <td class="
                                    <?php 
                                    if ($item['slamaran2'] === NULL) {
                                        echo 'status-menunggu';
                                    } elseif ($item['slamaran2'] === 'Valid') {
                                        echo 'status-valid';
                                    } elseif ($item['slamaran2'] === 'Invalid') {
                                        echo 'status-invalid';
                                    }
                                    ?>" style="font-weight: bold; text-align: center; border-radius: 12px;">
                                    <?php 
        ...
        <footer>
            <div class="container text-center">
                <small>Copyright &copy; SMKN 6 Kabupaten Tangerang 2024</small>
            </div>
        </footer>
    </div>
